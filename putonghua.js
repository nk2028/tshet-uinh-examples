...
if (選項.更多選項) {
  ...
  if (選項.常母平聲陰聲韻聲母和船母平聲聲母 === 'tʂʰ') {
    if (is('常母 平聲 陰聲韻') || is('船母 平聲')) 聲母 = 'ch';
  }
  if (選項.常母平聲陰聲韻聲母和船母平聲聲母 === 'ʂ') {
    if (is('常母 平聲 陰聲韻') || is('船母 平聲')) 聲母 = 'sh';
  }
   ...
   */
  if (選項.清聲母入聲調分派層次 === '皆派入上聲') {
    if (is('入聲 清音')) 聲調 = '3';
  }
  if (選項.清聲母入聲調分派層次 === '皆派入陰平') {
    if (is('入聲 清音')) 聲調 = '1';
  }
  if (選項.清聲母入聲調分派層次 === '次清、擦音和零聲母字派入去聲，其餘派入陽平') {
    if (is('入聲')) {
      if (is('心母') || is('生母') || is('書母') || is('曉母') || is('影母') || is('次清')) 聲調 = '4';
      if (is('全清')) 聲調 = '2';
    }
  }
  if (選項.清聲母入聲調分派層次 === '次清和零聲母字派入去聲，其餘派入陽平') {
    if (is('入聲')) {
      if (is('影母') || is('次清')) 聲調 = '4';
      if (is('全清')) 聲調 = '2';
    }
  }
  if (選項.清聲母入聲調分派層次 === '連同濁聲母、所有入聲字皆派入去聲') {
    if (is('入聲')) 聲調 = '4';
  }
}
