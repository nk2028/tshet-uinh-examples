...
function 聲母規則(白讀) {
  return when([
    ['幫滂並明母', [
      [!白讀 && '東韻 三等 或 鍾微虞廢文元陽尤凡韻', is`明母` ? 'v' : 'f'],
      ['幫母', 'b'],
      ['滂並母', 'p'],
      ['明母', 'm'],
    ]],
    ...
    ['心母', 's'],
    ['邪母', [
      ['支脂之微韻 去聲 或 魚虞模東冬鍾侵韻 平聲 或 侯尤幽麻韻', 'c'],
      ['', 's'],
    ]],
...
function 韻母規則(白讀) {
  return when([
    ...
    ['刪山韻', [
      ['脣音', 'an'], // 例外: 慢 een; 八捌 eed
      ['開口 見影組', 'ien'], // 例外: 限 een; 瞎 eed
      ['開口', 'an'],
      ['合口 見影組', 'uan'], // (>an/輕脣_)
      ['合口', 'on'],
    ]],
    ...
    ['庚韻 二等', [
      ['脣音 或 開口', 白讀 ? 'ang' : 'en'],
      ['合口', 白讀 ? 'uang' : 'uen'], // (>白ang|文en/輕脣_)
    ]],
    ['庚韻 三等', [
      ['脣音 或 開口', 白讀 ? 'iang' : 'in'], // (>白ang|文in/翹舌_) 例外: 盟省 en
      ['合口', 白讀 ? 'iung' : 'un'], // (>白ung|文un/翹舌_) 例外: 憬 in
    ]],
    ['耕韻', 白讀 ? 'ang' : 'en'], // 例外: 拼莖 in
    ['清韻', 白讀 ? 'iang' : 'in'], // (>白ang|文in/翹舌_) 例外: 碧 ed
    ['青韻', [
      ['端見組 或 來母', is`舒聲` ? 'en' : 'id'],
      ['', 白讀 ? 'iang' : 'in'], // 例外: 星 en
    ]],
    ...
    // 咸攝
    ['覃談咸銜凡韻', 'am'], // 例外: 鹹 eem; 減 iam; 夾插 iab
    ['鹽嚴韻', 'iam'], // (>am/翹舌_) 例外: 黏驗 eem; 躡 eeb
    ['添韻', [
      ['端組 或 來母', 'eem'],
      ['', 'iam'], // (>am/翹舌_)
    ]],
