  ...
  return when([
    ...
    ['蟹攝', [
      ['三四等', [
        ['廢韻', 白讀 ? 'oi' : 'ui'],
        ['脣音', 'i'],
        ['祭韻 合口', 白讀 ? 'oi' : 'ui'], // 例外: 脆 cioi5 歲 sei5
        ['齊韻 開口 影組', 'i'],
        ['齊韻 開口', 白讀 ? 'ei' : 'i'], // 例外: 梯 toi1
        ['齊韻 合口', 'ui'],
        ['祭韻 開口', 'i'], // (>ii/翹舌_)
      ]],
      ['二等', [
    ...
    ['山攝', [
      ['三四等', [
        ['元韻 脣音', 'an'], // 例外: 飯 on
        ['元韻', 'ien'], // (>een/翹舌_) 例外: 冤園遠 ien
        ['仙韻 脣音 或 仙韻 開口', 'ien'], // (>een/翹舌_)
        ['仙韻 合口 見影組', 'ien'], // (>een/翹舌_) 例外: 圓 vien2
        ['仙韻 合口 精莊組 入聲', 'ied'],
        ['仙韻 合口', 'ion'], // (>on/翹舌_)
        ['先韻 脣音', 白讀 ? 'een' : 'ien'],
        ['先韻 (端組 或 來母)', 'een'],
    ...
    ['梗曾攝', [
      ['三四等', [
        ...
        ['青清韻', 白讀 ? 'iang' : 'in'], // 例外: 星 en、碧 ed
        ['庚韻 脣音 或 庚韻 開口', 白讀 ? 'iang' : 'in'], // 例外: 盟省 en
        ['庚韻 合口', 白讀 ? 'iung' : 'un'], // 例外: 憬 in
      ]],
      ['二等', [
