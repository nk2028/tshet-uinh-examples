...
function 聲母規則() {
  ...
  if (is('莊母')){
    if (is('唐陽麻蕭豪肴宵江韻 或 支脂之微韻 合口 或 廢灰祭佳皆夬齊咍泰韻 二等 或 談覃鹽添咸銜嚴凡韻 二等 或 元寒桓刪山先仙韻 二等')) return 'zh'; 
    return 'z';
  }

  if (is('初母')){
    if (is('唐陽麻蕭豪肴宵江韻 或 支脂之微韻 合口 或 廢灰祭佳皆夬齊咍泰韻 二等 或 談覃鹽添咸銜嚴凡韻 二等 或 元寒桓刪山先仙韻 二等')) return 'ch';
    return 'c';
  }

  if (is('崇母')) {
    if (is('唐陽麻蕭豪肴宵江韻 或 支脂之微韻 合口 或 廢灰祭佳皆夬齊咍泰韻 二等 或 談覃鹽添咸銜嚴凡韻 二等 或 元寒桓刪山先仙韻 二等')) return is('平聲') ?'ch':'zh';
    if (is('之韻')) return 's';
    return is('平聲') ?'c':'z';
  }

  if (is('生母')) {
    if (is('唐陽麻蕭豪肴宵江韻 或 支脂之微韻 合口 或 廢灰祭佳皆夬齊咍泰韻 二等 或 談覃鹽添咸銜嚴凡韻 二等 或 元寒桓刪山先仙韻 二等')) return 'sh';
    return 's';
  }
  ...
  if (is('常母')) {
     ...
     if(is('鍾韻 上聲 或 平聲 或 一等')) return 'ch'; 
     return 'sh';
  }
  ...
  if (is('日母')) {    
    if(is('四等')) return 'l'; 
    if(is('支之脂韻 或 眞侵韻 入聲')) return ''; 
    return 'r';
  } 

  if (is('見母')) {
    if (is('一等 或 四等 齊韻 或 二等 合口 或 二等 庚耕韻 或 三等 合口 祭微陽支脂韻 或 三等 開口 通攝 舒聲')) return 'g'; 
    return 'j';
  }
  if (is('溪母')) {
    if (is('一等 或 四等 齊韻 或 二等 合口 或 二等 庚耕皆韻 或 二等 開口 江韻 入聲 或 三等 合口 祭微陽支脂凡廢韻 舒聲 或 三等 鍾韻 上聲 或 三等 鍾韻 去聲')) return 'k'; 
    return 'q';
  }
  if (is('羣母')) {    
    if(is('宵韻 重紐A類')) return 'q';
    if (is('平聲')) { 
      if (is('三等 合口 山陽脂韻')) return 'k'; 
      return 'q';
    };
    if (is('一等 或 四等 齊韻 或 二等 合口 或 二等 庚耕韻 或 三等 合口 祭微陽支脂凡廢韻 舒聲 或 三等 開口 通攝 舒聲')) return 'g'; 
    return 'j';
  }
  if (is('疑母')){
    if (is('四等 齊韻 平聲 或 四等 先韻 入聲 或 三等 尤蒸韻 平聲 或 三等 庚仙蒸陽韻 入聲 或 三等 之韻 上聲')) return 'l'; 
    return '';
  } 

  if (is('曉母')) {
    if (is('一等 或 四等 合口 齊韻 或 二等 合口 或 二等 庚耕皆韻 或 三等 合口 祭微陽支脂凡廢韻 舒聲')) return 'h'; 
    return 'x';
  }

  if (is('匣母')) {
    if (is('一等 或 四等 合口 齊韻 或 二等 合口 或 二等 庚耕韻 或 二等 皆韻 上聲')) return 'h'; 
    return 'x';
  }
...
function 韻母規則() {
  ...
  if (is('山攝')) {
    if (is('入聲')) {    
      ...
      if (is('以母')) return 'io';
      if (is('日母 或 知莊章組')) return 'ä';//Yu Li
