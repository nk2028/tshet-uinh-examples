...
function 韻母規則(文讀) {
  ...
  if (is('魂韻 舒聲 牙喉音 疑母'))
    return 文讀 ? (分困恐 ? 'uəŋ' : 'oŋ') : 'əŋ▽'; // 「諢」。白讀類推無實例
  if (is('魂韻 舒聲 牙喉音')) return 分困恐 ? 'uəŋ' : 'oŋ';
  if (is('魂韻 舒聲')) return 'əŋ';
  if (is('魂韻 入聲 牙喉音 疑母'))
    return 文讀 ? (分國骨 ? 'uəʔ▽' : 'oʔ▽') : 'əʔ'; // 「兀」
  ...
  if (is('寒韻 入聲 合口 牙喉音 疑母'))
    return 文讀 ? (分國骨 ? 'uəʔ▽' : 'oʔ▽') : 'əʔ'; // 字典弗曾收「枂」
  ...
  if (is('刪山韻 舒聲 開口 牙喉音'))
    return 文讀 ? (分衣煙 ? 'iɪ▽' : 'i▽') : 分來蘭 ? 'æ' : 'e'; // 「間」等
  ...
  if (is('仙先韻 舒聲 合口 舌齒音 日母'))
    return 文讀 ? 'ø▽' : 分于園 ? 'yø' : 'y'; // 「軟」等
  ...
  if (is('陽韻 舒聲 舌齒音 齒音 日母'))
    return 文讀 ? 'ɑ̃▽' : 分打黨 ? 'iã' : 'iɑ̃'; // 「壤」等
  if (is('陽韻 舒聲 舌齒音')) return 'ɑ̃';
  if (is('陽韻 舒聲 開口 牙喉音')) return 分打黨 ? 'iã' : 'iɑ̃';
  if (is('陽韻 舒聲 合口 牙喉音 云母'))
    return 文讀 ? 'uɑ̃' : 分打黨 ? 'iã▽' : 'iɑ̃▽'; // 「旺」等
  ...
  if (is('陽韻 入聲 舌齒音 日母'))
    return 文讀 ? (分袜麦 ? 'ɑʔ' : 'ɐʔ') : 分袜麦 ? 'iɑʔ▽' : 'iɐʔ▽'; // 「箬」等
  ...
  if (is('庚韻 入聲 二等 開口 牙喉音'))
    return 文讀 ? 'əʔ▽' : 分袜麦 ? 'ɑʔ' : 'ɐʔ'; // 「客」等。收於「上海土白集字」
  ...
  if (is('清青韻 舒聲 舌齒音 知章組'))
    return 文讀 ? 'əŋ' : 分打黨 ? 'ã▽' : 'ɑ̃▽'; // 「聲」等
  if (is('清青韻 舒聲 舌齒音')) return 'ɪɲ';
  if (is('清青韻 舒聲 開口 牙喉音'))
    return 文讀 ? 'ɪɲ' : 分打黨 ? 'iã▽' : 'iɑ̃▽'; // 理論白讀
  if (is('清青韻 舒聲 合口 牙喉音')) return 'ioŋ'; // 有異讀 /ɪɲ/
  if (is('清青韻 入聲 脣音')) return 'iɪʔ';
  if (is('清青韻 入聲 舌齒音 知章組'))
    return 文讀 ? 'əʔ▽' : 分袜麦 ? 'ɑʔ' : 'ɐʔ'; // 「適」等
  ...
  if (is('鹽添嚴韻 舒聲 舌齒音 日母'))
    return 文讀 ? 'ø' : 分衣煙 ? 'iɪ▽' : 'i▽'; // 「染」等
  ...
  if (is('咸銜凡韻 舒聲 牙喉音'))
    return 文讀 ? (分衣煙 ? 'iɪ▽' : 'i▽') : 分來蘭 ? 'æ' : 'e'; // 「減」等
