...
const 舒聲韻母規則 = () => when([
  ...
  ['蟹攝', [
    ['一二等', [
      ['開口', [['幫組', 'ei'], ['', 'ae']]], // FIXME 部分見組為 iɛ (介) iɑ (佳)
...
if (韻母 === 'ʅ' && ['z', 'c', 's'].includes(聲母)) {
  韻母 = 'ɿ';
}

if (選項.標調方式 === '數字') return 聲母 + 韻母 + 聲調;
if (選項.標調方式 === '附標') return 聲母 + (聲調 ? 韻母.replace(/.*[aɑ]|.*[eɛoɤʅɿ]|.*[iuü]/, '$&' + ' ́̀̄̌'[聲調]) : 韻母);
