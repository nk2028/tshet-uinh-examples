...
if (!音韻地位) return [
  ['注音符號\n否的話就用國際音標', true],
  ['注音符號省略陰平調號', false, {hidden: 選項.注音符號 !== true}],
  選項.注音符號 === false ? '音標風格' : undefined,
  ['ㄬㄭ|ㄬ ㄭ', [2, 'ȵ ɿ ʅ', 'ɲ ɹ̩ ɻ̍'], {hidden: 選項.注音符號 === true}],
  ['介音', [1, {text: 'i u y', value: '元音'}, {text: 'j w ɥ', value: '半元音'}], {hidden: 選項.注音符號 === true}],
  ['ㄚ|ㄧㄞ ㄧㄢ ㄩㄢ', [2, 'iæi iɛn yɛn', 'iai ian yan'], {hidden: 選項.注音符號 === true}],
