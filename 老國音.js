...
if (!音韻地位) return [
  ...
  ...(選項.注音符號 !== false ? [
    ...
    ['ㄬㄭ|ㄬ ㄭ', [2, 'ȵ ɿ ʅ', 'ɲ ɹ̩ ɻ̍']],
    ['介音', [1, {text: 'i u y', value: '元音' }, {text: 'j w ɥ', value: '半元音' }]],
    ['ㄚ|ㄧㄞ ㄧㄢ ㄩㄢ', [2, 'iæi iɛn yɛn', 'iai ian yan']], // 完
...
if (['tʂ', 'tʂʰ', 'ʂ', 'ɻ'].includes(聲母)) {
  if (['i', 'iʔ'].includes(韻母)) 韻母 = 'ɻ̍' + 韻母.slice(1);
...
// ㄬㄭ
if (選項.注音符號 !== true && 選項.ㄬㄭ === 'ȵ ɿ ʅ') {
  if (聲母 === 'ɲ') 聲母 = 'ȵ';
  if (韻母 === 'ɹ̩') 韻母 = 'ɿ';
  if (韻母[0] === 'ɻ') 韻母 = 'ʅ' + 韻母.slice(2);
}
...
if (選項.注音符號 === true && ['ɹ', 'ɻ'].includes(韻母[0])) 韻母 = '';
