...
if (!音韻地位) return [
  ...
  ['ㄬㄭ|ㄬ ㄭ', [1, 'ɲ ɹ̩ ɻ̍', 'ȵ ɿ ʅ'], { hidden: 選項.注音符號 !== false }],
  ['介母|介音', [1,
    { text: 'i u y', value: '元音' },
    { text: 'j w ɥ', value: '半元音' },
  ], { hidden: 選項.注音符號 === true }],
  ['ㄚ|ㄧㄞ ㄧㄢ ㄩㄢ', [1, 'iai ian yan', 'iæi iɛn yɛn'], { hidden: 選項.注音符號 !== false }],
...
if (韻母[0] === 'i' && 聲母 === 'ŋ') 聲母 = is`(齊之尤蒸陽韻 非 合口) 或 (侵仙先元庚韻 入聲)` ? 'ɲ' : '';
if (韻母[0] === 'y' && 聲母 === 'ŋ') 聲母 = '';
