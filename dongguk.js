...
const 轉寫 = {
  '耶魯轉寫': {
    ...
    ᆞ: 'o', ᆡ: 'oy', ᅩ: 'wo', ᅬ: 'woy', ᅭ: 'yo',
    ᅳ: 'u', ᅴ: 'uy', ᅮ: 'wu', ᅱ: 'wuy', ᅲ: 'yu', ᆔ: 'yuy',
    ᅵ: 'i',
    ᅡ: 'a', ᅢ: 'ay', ᅪ: 'wa', ᅫ: 'way', ᅣ: 'ya', ᅤ: 'yay',
    ᅥ: 'e', ᅦ: 'ey', ᅯ: 'we', ᅰ: 'wey', ᅧ: 'ye', ᅨ: 'yey', ᆑ: 'yuye', ᆒ: 'yuyey',
...
function 音變(音節) {
  ...
  替換('初聲', { ᄃ: 'ᄌ', ᄐ: 'ᄎ' }, 'ᅵᅭᅣᅲᅧᅨ'.includes(音節.中聲));
