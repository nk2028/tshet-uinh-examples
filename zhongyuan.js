...
function get韻母() {
  ...
  let 韻基 = when([
    [例外, [
      [層次 === 1 && '心母 止攝 開口 上聲 非 脂韻', 'jəj'], // 璽枲徙\死（避諱。元曲“徙”押支思）
    ...
    ['舒聲', [
      [例外, [
        ...
        ['溪母 登韻 上聲 或 以母 蒸韻 去聲', 'ən'], // 肯孕
        [層次 === 1 && '知母 清韻 或 昌母 蒸韻 去聲', 'ən'], // +貞稱（元曲押真文、庚青）
      ]],
      ['通攝', 'uŋ'], // 東鍾韻
      ['宕江攝', 'aŋ'], // 江陽韻
      ['曾梗攝', 'əŋ'], // 庚青韻
...
function get音節() {
  ...
  const 轉換規則字典 = {
    ...
    '音值（unt, 2021）': [
      ['β', ''],
      ['ə', 'ï', 韻母 === 'ə' && 選項.高元音開口呼 === 'ə'],
      ['ï', 'ɹ̩', 聲母.includes('s'), 'ɻ̍'],
      ['jw', 'ɥ'], ['əj', 'əi'],
      ['jə', 'i'], ['ii', 'i'],
      ['wə', 'u', !韻母.includes('ŋ')],
      ['ɥə', 'y', !韻母.includes('ŋ'), 'ɥi'],
      ['ʌw', 'waw', is脣音, 'aw'],
